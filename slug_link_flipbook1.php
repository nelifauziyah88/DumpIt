...
<head>
    ...
    <link rel="stylesheet" href="css/slug_flipbook1.css" />
</head>
...
<body>
    ...
    <nav>
        ...
        <a href="create_flipbook1.php" class="back-btn">
    ...
    <div class="main">
        ...
        <div class="card">
            <div class="card-head">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8b1a1a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="nav-row">
            <a href="create_flipbook1.php" class="btn-sec">
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="flipbook1.php" class="btn-open" id="flipbookBtn">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <script src="js/slug_link_flipbook1.js"></script>
</body>
