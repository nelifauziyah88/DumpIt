...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400;1,700&family=Lora:ital,wght@0,400;0,600;1,400;1,600&family=Satisfy&family=Raleway:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="css/flipbook6.css" />
</head>
...
<body>
    ...
    <div id="topbar">
        <a href="index.php" class="tb-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="24" height="24">
                <rect x="3" y="3" width="30" height="30" rx="7" fill="#2d6fa3" />
    ...
    <script src="js/flipbook6.js"></script>
</body>
