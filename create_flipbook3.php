...
<head>
  ...
  <title>Buat Sweet Memories — DumpIt</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="icon" type="image/svg+xml"
    href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%23c2415c'/%3E%3Cstop offset='100%25' stop-color='%23e8a0b0'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect x='4' y='4' width='32' height='32' rx='8' fill='url(%23g)'/%3E%3Crect x='10' y='9' width='13' height='20' rx='2' fill='white' opacity='.95'/%3E%3Crect x='12' y='13' width='9' height='1.4' rx='1' fill='%23c2415c' opacity='.45'/%3E%3Crect x='12' y='16' width='7' height='1.4' rx='1' fill='%23c2415c' opacity='.45'/%3E%3Crect x='12' y='19' width='8' height='1.4' rx='1' fill='%23c2415c' opacity='.45'/%3E%3Crect x='12' y='22' width='5' height='1.4' rx='1' fill='%23c2415c' opacity='.45'/%3E%3Crect x='24' y='10' width='2' height='17' rx='1' fill='white' opacity='.35'/%3E%3Cpath d='M26 10 Q31 13 31 18 Q31 23 26 27' stroke='white' stroke-width='1.4' fill='none' opacity='.55' stroke-linecap='round'/%3E%3C/svg%3E" />
  ...
  <link rel="stylesheet" href="css/create_flipbook3.css" />
</head>
<body>
  ...
  <nav>
    <a href="index.php" class="logo">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="26" height="26">
        <rect x="3" y="3" width="30" height="30" rx="7" fill="#c2415c"/>
        <rect x="8" y="8" width="12" height="19" rx="2" fill="white" opacity=".95"/>
        <rect x="10" y="12" width="8" height="1.4" rx="1" fill="#c2415c" opacity=".4"/>
        <rect x="10" y="15" width="6" height="1.4" rx="1" fill="#c2415c" opacity=".4"/>
        <rect x="10" y="18" width="7" height="1.4" rx="1" fill="#c2415c" opacity=".4"/>
  ...
  <div class="header">
    <div class="header-inner">
      <div class="header-tag">✦ Flipbook • Kolase Foto</div>
  ...
  <div class="main">
      ...
      <div class="card">
        <div class="card-head">
          ...
          <div>
            ...
            <div class="card-desc">Akan tampil di seluruh halaman flipbook</div>
          </div>
        </div>
        <div class="card-body">
          <div class="row">
        ...
        <div class="card-body">
          <div class="cover-drop" id="coverDrop">
            ...
            <div class="drop-label" id="coverPlaceholder">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
      ...
      <div class="card">
        <div class="card-head">
          ...
          <div>
            ...
            <div class="card-desc">Upload hingga 9 foto — tersebar otomatis di halaman flipbook</div>
          </div>
        </div>
        <div class="card-body">
    ...
    <div class="preview-col">
        ...
        <div class="prev-body">
          <div class="mini-book">
            <div class="mini-frame" id="miniFrame">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="miniPh" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
            </div>
            <div class="mini-names" id="miniNames">Nama ♥ Nama</div>
            <div class="mini-sub">Sweet Memories</div>
          </div>
          <div class="count-row">
      ...
      <a href="slug_link_flipbook3.php" class="btn-create" onclick="saveData(); return true;">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
        Buat Flipbook
      </a>
      <div class="prev-note">Minimal 1 foto untuk membuat flipbook.<br>Semua teks terisi otomatis dari template.</div>
    </div>
  </div>

  <script src="js/create_flipbook3.js"></script>
</body>
</html>