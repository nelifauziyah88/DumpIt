...
const CLOUD_SVG = (w, h, op) => `<svg width="${w}" height="${h}" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg" opacity="${op || 1}">
...
const LOVE_NOTES = [
  {num:"I",txt:"Kehadiranmu bukan sesuatu yang aku anggap biasa. Setiap hari kamu ada adalah hari yang lebih berarti dari yang sebelumnya.",sig:"♡"},
  {num:"II",txt:"Aku tidak perlu dunia yang sempurna selama ada kamu yang menemani melangkah di dunia yang penuh ketidakpastian ini.",sig:"♡"},
  {num:"III",txt:"Mencintaimu mengajarkan aku bahwa cinta bukan tentang memiliki, tapi tentang bersedia hadir tanpa syarat apapun.",sig:"♡"},
  {num:"IV",txt:"Kamu bukan sekadar seseorang yang aku kenal. Kamu adalah alasan aku percaya bahwa hal indah itu nyata dan bisa dirasakan.",sig:"♡"},
  {num:"V",txt:"Di hari yang paling biasa sekalipun, ada satu hal yang selalu luar biasa yaitu fakta bahwa aku mengenalmu.",sig:"♡"},
  {num:"VI",txt:"Jika hidup adalah perjalanan panjang, aku bersyukur bisa melewatinya dengan seseorang yang membuat setiap langkah terasa ringan.",sig:"♡"},
];
    ...
    },
    {
      ...
      right:`<div class="pg polar">
        ...
        <div class="polar-grid">
          ${[2,3,4,5].map((i,idx)=>{
            const caps=["awal cerita kita","momen berharga","bersama kamu","selalu ♡"];
...
function flipTo(next,forward){
  ...
  requestAnimationFrame(function step(ts){
    ...
    fl.style.boxShadow=forward?`-${mid*10}px 0 ${mid*18}px rgba(0,0,0,${mid*0.22})`:`${mid*10}px 0 ${mid*18}px rgba(0,0,0,${mid*0.22})`;
