...
Maka izinkan aku untuk terus memilihmu, setiap hari, tanpa syarat`;
  ...
  const LOVE_NOTES = [
    {
      num: "I",
      txt: "Kamu bukan kebetulan yang datang tanpa tujuan. Kamu adalah hadiah yang aku terima dengan tangan terbuka dan hati penuh syukur.",
      sig: "♡",
    },
    {
      num: "II",
      txt: "Mencintaimu bukan soal perasaan yang selalu besar dan dramatis. Ini soal memilih tetap ada, bahkan di hari yang biasa sekalipun.",
      sig: "♡",
    },
    {
      num: "III",
      txt: "Di antara semua jalan yang bisa aku pilih, jalan yang membawaku ke kamu adalah yang paling tidak pernah aku sesali.",
      sig: "♡",
    },
    {
      num: "IV",
      txt: "Kamu bukan sekadar tempat aku pulang. Kamu adalah alasan aku menemukan arti dari kata rumah itu sendiri.",
      sig: "♡",
    },
    {
      num: "V",
      txt: "Hari yang biasa menjadi istimewa bukan karena kejadian besar, tapi karena ada kamu yang hadir di dalamnya.",
      sig: "♡",
    },
    {
      num: "VI",
      txt: "Kalau waktu bisa diputar ulang, aku tidak akan mengubah apapun selama kamu tetap ada di akhir ceritanya.",
      sig: "♡",
    },
  ];
