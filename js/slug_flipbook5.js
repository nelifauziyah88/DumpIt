...
function init() {
  ...
  document.getElementById("flipbookBtn").href = "flipbook5.php?slug=" + slug;
}
...
function shareWA() {
  const text = encodeURIComponent(
    "Hai! Aku buat scrapbook anniversary kita di DumpIt\nBuka di: dumpit.app/s/" +
      slug,
  );
...
function downloadPDF() {
  ...
  setTimeout(() => {
    ...
    window.open(
      "flipbook5.php?slug=" + slug + "&print=1&size=" + selectedSize,
      "_blank",
    );
  }, 2700);
}
