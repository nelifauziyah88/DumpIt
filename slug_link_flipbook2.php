...
<head>
    ...
    <link rel="icon" type="image/svg+xml"
        href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0%25' y1='0%25' x2='100%25' y2='100%25'%3E%3Cstop offset='0%25' stop-color='%233a6b49'/%3E%3Cstop offset='100%25' stop-color='%236aab7e'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect x='4' y='4' width='32' height='32' rx='8' fill='url(%23g)'/%3E%3Crect x='10' y='10' width='14' height='20' rx='2' fill='white' opacity='.95'/%3E%3Crect x='12' y='14' width='10' height='1.5' rx='1' fill='%233a6b49' opacity='.5'/%3E%3Crect x='12' y='17' width='8' height='1.5' rx='1' fill='%233a6b49' opacity='.5'/%3E%3Crect x='12' y='20' width='9' height='1.5' rx='1' fill='%233a6b49' opacity='.5'/%3E%3Crect x='12' y='23' width='6' height='1.5' rx='1' fill='%233a6b49' opacity='.5'/%3E%3Crect x='25' y='11' width='2' height='18' rx='1' fill='white' opacity='.4'/%3E%3Cpath d='M27 11 Q32 14 32 20 Q32 26 27 29' stroke='white' stroke-width='1.5' fill='none' opacity='.6' stroke-linecap='round'/%3E%3C/svg%3E" />
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;1,300;1,400&family=DM+Sans:wght@300;400;500&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/slug_flipbook2.css" />
</head>
...
<body>
    ...
    <nav>
        ...
        <a href="create_flipbook2.php" class="back-btn">
    ...
    <div class="main">
        ...
        <div class="name-display">
            ...
            <div class="sub">Sweet Memories Vol. 2</div>
        </div>

        <div class="card">
            <div class="card-head">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3a6b49" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="nav-row">
            <a href="create_flipbook2.php" class="btn-sec">
                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="flipbook2.php" class="btn-open" id="flipbookBtn">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <script src="js/slug_link_flipbook2.js"></script>
</body>
